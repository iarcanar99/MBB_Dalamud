...
class CardView:
    ...
    def _create_card_ui(self):
        ...
        # --- แสดงข้อมูลส่วนเนื้อหา (ใน content_frame) ---
        if self.section_type == "main_characters":
            role_label = tk.Label(
...
class NPCManagerCard:
    ...
    def __init__(
        ...
        on_game_swapped_callback=None,  # FIX: เพิ่ม Argument ใหม่ที่นี่
        ...
        self.on_game_swapped_callback = (
            on_game_swapped_callback  # FIX: เก็บ callback ไว้ใน instance
        )
    ...
    def show_enhanced_character_added_dialog(self, character_name, character_data):
        ...
        try:
            ...
            dialog.focus_force()  # บังคับ focus
    ...
    def show_window(self):
        ...
        self.window.focus_force()  # บังคับ focus
    ...
    def _safe_after(self, delay, callback):
        ...
        # ป้องกัน timer สะสมมากเกินไป
        if len(self._all_timers) > 100:  # จำกัดไม่เกิน 100 timers
            if hasattr(self, "logging_manager"):
                self.logging_manager.log_warning(
    ...
    def _force_ui_unlock(self):
        """บังคับ unlock UI ที่อาจติดค้าง"""
        try:
            if hasattr(self, "window") and self.window.winfo_exists():
    ...
    def _comprehensive_cleanup(self):
        """ทำความสะอาดทรัพยากรและ state ต่างๆ อย่างครอบคลุม"""
        try:
            # 1. ยกเลิก pending timers ทั้งหมด
            ...
            # 2. ปลด event bindings ที่อาจค้างอยู่
            ...
            # 5. ทำความสะอาด detail form elements
            if hasattr(self, "detail_form_elements"):
...
def create_npc_manager_card(
    ...
    return NPCManagerCard(
        ...
        on_game_swapped_callback,  # FIX: และส่งต่อไปให้ Class __init__
    )
